...
from gosbs.builder import rpcapi as builder_rpcapi
...
from gosbs.tasks import builder as builder_tasks
...
class BuilderManager(manager.Manager):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.builder_rpcapi = builder_rpcapi.BuilderAPI()

        super(BuilderManager, self).__init__(service_name="Builder",
                                             *args, **kwargs)
    ...
    def pre_start_hook(self):
        ...
        self.service_ref = objects.Service.get_by_host_and_topic(
            context, self.host, "builder")
        builder_tasks.activete_all_tasks(context, self.service_ref.uuid)

    def reset(self):
        LOG.info('Reloading builder RPC API')
        builder_rpcapi.LAST_VERSION = None
        self.builder_rpcapi = builder_rpcapi.BuilderAPI()
